...
Both do the same thing, but we'll see later that using functions lik `subset` or `filter` is preferable if we plan on chaining together a bunch of data manipulation commands using pipes (`%>%` or `|>`).
